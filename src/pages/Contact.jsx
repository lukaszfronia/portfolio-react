...
const Contact = () => {
  return (
    <div
      id="contact"
      className="xl:max-w-[1200px] lg:max-w-[1000px] md:max-w-[700px] sm:max-w-[600px] max-w-[340px] mx-auto xl:py-32 lg:py-80 py-10 sm:py-56  text-gray-900 flex flex-col items-center gap-32"
    >
